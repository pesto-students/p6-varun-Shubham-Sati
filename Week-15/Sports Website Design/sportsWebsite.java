...
public class Game{
    ...
    Game( int _id , Team team1 , Team team2 , String status , int score ){
        this._id = _id;
        this.team1 = team1;
        this.team2 = team2;
        this.status = status;
...
public class GameServices{
    ...
    GameServices( Game currentGame ){
        this.currentGame = currentGame;
    }

    public Game create_gate( Team team1 , Team team2 ){
        game = new Game( team1 , team2 );
        this.games.append( game );
        return Game;
    }

    pubilc Game start_game( Game game ){
        while( true ){
    ...
    public void end_game( Game currentGame , LocalDateTime currentTime ){
